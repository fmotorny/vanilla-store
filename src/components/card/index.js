...
class Card extends BaseComponent {
  ...
  get template() {
    const { rate, price, title, desc, image } = productMap(
    ...
    return `
      <div class="os-product-card">
        ...
        <div class="os-product-img" style="background-image: url(${image});"></div>
        ...
        <div class="os-product-content">
          ...
          <p class="os-product-description">${desc.slice(0, 50) + "..."}</p>
        </div>
        ${this.footer}
      </div>
    `;
